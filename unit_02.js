...
//Так получается, потому что в ковычках записывается строка(текст), а без ковычек числовое значение.
...
function t9() {
  document.querySelector(".out-9").textContent = document.querySelector(
    ".i-9"
  ).value;
...
function t10() {
  let ab = document.querySelector(".i-10").value;
  document.querySelector(".out-10").textContent = ab * 10;
}
...
function t11() {
  let ac = document.querySelector(".i-11").value;
  document.querySelector(".out-11").textContent = +ac + 10;
}
...
function t12() {
  let a = document.querySelector(".i-12_1").value;
  let b = document.querySelector(".i-12_2").value;
  document.querySelector(".out-12").textContent = "Hello " + a + " " + b;
}
...
function t20() {
  let a = document.querySelector(".i-20-1").value;
  let b = document.querySelector(".i-20-2").value;
  let с = document.querySelector(".i-20-3").value;
  let d = document.querySelector(".i-20-4").value;
  let e =
    "Уважаемый " +
    a +
    " " +
    ...
    d;
  document.querySelector(".out-20").textContent = e;
}
